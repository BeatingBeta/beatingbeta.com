...
define( 'NOTIFIER_THEME_NAME', 'SuperSkeleton' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'super-skeleton' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://www.mdnw.net/update-logs/notifier-superskeleton.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
