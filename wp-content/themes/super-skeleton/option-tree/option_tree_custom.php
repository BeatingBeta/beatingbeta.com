...
#option_frontpage .option-colorpicker .element, #option_frontpage .option-colorpicker h3{display: none;}
#option_frontpage .option-colorpicker .description{width: 100% !important;}

#option_skeleton_slider .option-colorpicker .element, #option_frontpage .option-colorpicker h3{display: none;}
#option_skeleton_slider .option-colorpicker .description{width: 100% !important;}

#option_general_default .option-colorpicker .element, #option_frontpage .option-colorpicker h3{display: none;}
#option_general_default .option-colorpicker .description{width: 100% !important;}

#option_documentation .option-colorpicker .element, #option_frontpage .option-colorpicker h3{display: none;}
#option_documentation .option-colorpicker .description{width: 100% !important;}


#akismet-warning{display: none;}
