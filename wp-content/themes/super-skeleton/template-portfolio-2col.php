...
<!-- Super Container -->
<div class="super-container full-width main-content-area portfolio-2" id="section-content">
	...
	<div class="container">	
			...
			<div class="sixteen columns portfolio-nav">
				...
				<p class="portfolio-view">
					...
					<span class="grid_btn 2-col-grid"><img src="<?php echo WP_THEME_URL; ?>/assets/images/theme/btn_grid.png" alt="Grid View" /></span> 
					<span class="hybrid_btn 2-col-hybrid"><img src="<?php echo WP_THEME_URL; ?>/assets/images/theme/btn_hybrid.png" alt="Hybrid View" /></span>
					<span class="list_btn 2-col-list"><img src="<?php echo WP_THEME_URL; ?>/assets/images/theme/btn_list.png" alt="List View" /></span>
				</p>
				<br /><br />
			...
			<?php while (have_posts()) : the_post(); ?>
				...
				<?php if (has_post_thumbnail( $post->ID )) {
						...
						<div class="eight columns module-container 				
